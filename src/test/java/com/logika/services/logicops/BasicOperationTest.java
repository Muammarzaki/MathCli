...
public class BasicOperationTest {
    ...
    public void testDanOps() {
        ...
        assertArrayEquals(List.of(true, false, false, false).toArray(), basicOperation.andOps().toArray());
    }
    ...
    void testorOps() {
        ...
        assertArrayEquals(List.of(true, true, true, false).toArray(), basicOperation.orOps().toArray());
    }
    ...
    void bimOpsTest() {
        ...
        assertArrayEquals(List.of(true, false, true, true).toArray(), basicOperation.impOps().toArray());
    }
    ...
    void bimOps2Test() {
        ...
        assertArrayEquals(List.of(true, false, false, true).toArray(), basicOperation.bimpOps().toArray());
    }
